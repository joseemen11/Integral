    ...
    <div className="col-span-4 md:col-span-6 sm:col-span-8 col:col-span-12 order-2 md:order-3">
      ...
      before:border-t-[13px] before:border-t-[rgba(0,0,0,.1)]
       before:top-full before:left-[30px] "
          >
            <h3 className="text-[24px] text-[#282e3f]">Trabajamos con</h3>
          </div>
            ...
            <ul>
              {Practices.map((practice, Pitem) => (
                <li className="border-b border-[#ddd]" key={Pitem}>
                  ...
                  <h3 className="text-[15px] pt-[15px] pb-[10px] text-[#333] block transition-all text-bold ease-in-out hover:text-navbar">
                    {practice.sTitle}
                  </h3>
                </li>
              ))}
        ...
        <div className="mt-[65px] pt-[15px] px-[30px] pb-[20px] bg-[#f5f5f5] sm:hidden md:hidden">
          <h3
