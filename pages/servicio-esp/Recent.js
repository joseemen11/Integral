...
const RecentCase = (props) => {
  ...
  return (
   ...
   before:w-[60px] before:h-[2px] before:bg-section"
      >
        Servicios ofrecidos
      </h2>
            ...
            <div className="col-span-4 md:col-span-6 col:col-span-12" key={i}>
              <div className="relative group md:mb-[30px]">
                <div className="studies-single">
                  <Image className="h-full" src={cases.cImg} alt="" />
                </div>
                <div
                  className="absolute bottom-[-80px] bg-navbar/70 w-[calc(100%)] h-[calc(100%)] transition ease-in-out duration-500 opacity-0 invisible 
