...
const Cases = [
  {
    ...
    subtitle:
      "En INTEGRALPRO S.R.L., entendemos que una contabilidad precisa y bien gestionada es el corazón financiero de cualquier negocio. Nuestro equipo de expertos está comprometido en brindarte soluciones contables personalizadas para asegurar que tus finanzas estén siempre en orden y alineadas con la normativa vigente.",

    casecontent: [
      {
        contentTitle: "CONTABILIDAD INTEGRAL",
        contentSubtitle:
          "Gestionamos tu contabilidad de manera integral para que puedas enfocarte en hacer crecer tu empresa. Nuestro equipo se encargará de cada aspecto contable - tributario garantizando exactitud y cumplimiento normativo",
        content: [
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Evitas multas o sanciones por errores o incumplimientos tributarios.",
              },
              {
                title: "Optimización del tiempo:",
                subtitle:
                  "Te olvidas de los trámites contables y administrativos, enfocándote en lo esencial.",
              },
              {
                title: "Reducción de costos:",
                subtitle:
                  "No necesitarás contratar personal interno para el área contable.",
              },
              {
              ...
              },
              {
                ...
                subtitle:
                  "Proporcionamos reportes financieros claros que ayudan a dirigir tu empresa.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Registro contable mensual:",
                subtitle:
                  "Registro de todas las operaciones de la empresa en base a normas contables nacionales.",
              },
              {
                title: "Declaraciones Tributarias:",
                subtitle:
                  "Preparación y presentación de declaraciones de impuestos mensuales y anuales.",
              },
              {
                title: "Conciliaciones bancarias:",
                subtitle:
                  "Revisión y conciliación de los estados bancarios con las cuentas contables.",
              },
              {
                title: "Cierres contables anuales:",
                subtitle:
                  "Proceso integral de cierre de libros contables, asegurando un correcto balance de cierre.",
              },
              {
                title: "Elaboración de estados financieros:",
                subtitle:
                  "Balance General, Estado de Resultados, Flujo de Efectivo, Estado de Evolución del Patrimonio y Notas a los Estados Financieros.",
              },
              {
                title: "Reportes gerenciales:",
                subtitle:
                  "Entrega de reportes periódicos personalizados para la toma de decisiones.",
              },
            ],
          },
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Estado de resultados, balance general, flujo de caja y análisis de variaciones.",
              },
              {
                title: "Reportes de conciliación bancaria mensuales:",
                subtitle: "",
              },
              {
                title: "Declaraciones tributarias mensuales y anuales:",
                subtitle: "",
              },
              {
                title: "Reporte anual de cierre contable:",
                subtitle: "",
              },
            ],
          },
          {
            ...
            points: [
              ...
              {
                title: "Microempresas:",
                subtitle: "Precio básico con servicios esenciales.",
              },
              {
                title: "Pequeñas y medianas empresas (MYPEs):",
                subtitle:
                  "Paquete más completo y reportes gerenciales adicionales.",
              },
              {
                title: "Empresas grandes:",
                subtitle:
                  "Servicio personalizado con atención preferente y asesoría continua.",
              },
            ],
          },
          {
      ...
      {
        contentTitle: "DECLARACIÓN DE IMPUESTOS",
        contentSubtitle:
          "Nos encargamos de tus declaraciones de impuestos, asegurando que todo se presente correctamente y dentro de los plazos establecidos por el Servicio de Impuestos Nacionales, evitando multas y optimizando tus beneficios tributarios.",
        content: [
          {
            name: "BENEFICIOS CLAVE",
            points: [
              {
                title: "Cumplimiento Tributario:",
                subtitle:
                  "Te aseguras de que tus impuestos se declaren correctamente y a tiempo.",
              },
              {
                title: "Evitas sanciones:",
                subtitle:
                  "Prevención de multas y recargos por errores o retrasos en la presentación.",
              },
              {
                title: "Optimización tributaria:",
                subtitle:
                  "Identificación de beneficios tributarios aplicables para reducir tu carga impositiva.",
              },
              {
                title: "Ahorro de tiempo:",
                subtitle:
                  "Nos ocupamos de todo, liberándote de la carga administrativa.",
              },
            ],
          },
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Presentación de los impuestos IVA, IT, RC-IVA, e IUE según corresponda.",
              },
              {
                title: "Cálculo de Impuestos:",
                subtitle:
                  "Revisión y cálculo de los impuestos a pagar según la normativa vigente.",
              },
              {
                title: "Gestión de pagos:",
                subtitle:
                  "Facilitamos la gestión del pago de impuestos ante el banco.",
              },
              {
                title: "Actualización en Cambios Tributarios:",
                subtitle:
                  "Te mantenemos informado sobre cambios en la normativa tributaria.",
              },
              {
                title: "Declaración Anual:",
                subtitle:
                  "Gestión completa de la declaración del Impuesto sobre las Utilidades (IUE).",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Formularios de presentación:",
                subtitle:
                  "Declaraciones Juradas Certificadas por el Servicio de Impuestos Nacionales.",
              },
              {
                title: "Reporte Mensual:",
                subtitle: "Resumen de los impuestos calculados y presentados.",
              },
              {
                title: "Asesoría en deducciones:",
                subtitle:
                  "Recomendaciones específicas para aprovechar beneficios Tributarios.",
              },
            ],
          },

          {
            ...
            points: [
              {
                title: "Revisión Gratuita de los Últimos 12 Meses:",
                subtitle:
                  "Al contratar el servicio anual, hacemos una revisión de tus declaraciones de impuestos anteriores para verificar su correcto cumplimiento.",
              },
            ],
          },
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Dependiendo del tamaño de la empresa y la complejidad fiscal.",
              },
            ],
          },
        ],
      ...
      {
        contentTitle: "CONTABILIDAD PARA EL SECTOR ECONÓMICO NO FORMAL",
        contentSubtitle:
          "Simplificamos la contabilidad y las finanzas de aquellos emprendimientos o negocios que se encuentren dentro del sector económico no formal con el fin de que éstos puedan concentrarse en hacer crecer tu negocio.",
        content: [
          {
            name: "BENEFICIOS CLAVE",
            points: [
              {
                title: "Simplicidad:",
                subtitle:
                  "Nos encargamos de toda la información contable y financiera para que puedas enfocarte en tu producto o servicio.",
              },
              {
                title: "Ahorro de costos:",
                subtitle:
                  "Servicio económico, ideal para emprendedores con presupuestos ajustados.",
              },
              {
                title: "Escalabilidad:",
                subtitle:
                  "A medida que tu negocio crezca, adaptamos nuestros servicios a tus nuevas necesidades.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Registros Contables Básicos:",
                subtitle:
                  "Ingresamos las transacciones financieras de tu negocio.",
              },
              {
                title: "Reportes Financieros Anuales:",
                subtitle:
                  "Al finalizar el año, hacemos el cierre de tus finanzas determinando si existió ganancia o pérdida y preparamos tu empresa para asumir el siguiente ejercicio.",
              },
            ],
          },
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Estado de Resultados y Flujo de Caja que reflejan el estado financiero de tu negocio.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Tarifa mensual reducida:",
                subtitle:
                  "Pensado especialmente para negocios con un número limitado de transacciones.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Asesoría en Planificación Financiera:",
                subtitle:
                  "Consejos gratuitos sobre cómo definir objetivos de corto plazo y como hacer su seguimiento para la mejora continua.",
              },
            ],
          },
        ],
      ...
      {
        contentTitle: "LEVANTAMIENTO DE INVENTARIOS",
        contentSubtitle:
          "Realizamos el levantamiento de inventarios correspondientes a un periodo determinado de manera precisa y eficiente, brindándote un control total sobre tus bienes, productos o activos.",
        content: [
          {
            name: "BENEFICIOS CLAVE",
            points: [
              {
                title: "Control de tus inventarios:",
                subtitle:
                  "Saber exactamente lo que tienes, dónde está y en qué estado se encuentra.",
              },
              {
                title: "Reducción de pérdidas:",
                subtitle:
                  "Identificamos posibles robos, daños u otros desvíos de inventario.",
              },
              {
                title: "Mejor toma de decisiones:",
                subtitle:
                  "Datos claros y actualizados te permiten gestionar tus compras y ventas de forma eficiente.",
              },
              {
                title: "Cumplimiento contable:",
                subtitle:
                  "Garantizamos que tu inventario esté correctamente registrado para efectos contables y tributarios.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Toma física de inventarios:",
                subtitle:
                  "Contamos y registramos manualmente todos los bienes, productos o activos de tu empresa.",
              },
              {
                title: "Clasificación y etiquetado:",
                subtitle:
                  "Identificamos y clasificamos cada ítem según su categoría, ubicación y estado.",
              },
              {
                title: "Control de activos fijos:",
                subtitle:
                  "Levantamiento de inventarios de maquinaria, equipos y otros activos fijos.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Informe de Inventario Completo:",
                subtitle:
                  "Detalle de los productos y activos registrados, con su respectiva ubicación y estado.",
              },
              {
                title: "Análisis de Discrepancias:",
                subtitle:
                  "Detalle de diferencias entre el inventario físico y los registros contables, con recomendaciones de ajustes.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title:
                  "Tarifa según el tamaño y la complejidad del inventario:",
                subtitle: "",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Capacitación en Control de Inventarios:",
                subtitle:
                  "Taller gratuito para tu personal sobre mejores prácticas de control y manejo de inventarios.",
              },
            ],
          },
        ],
        ...
        content: [
          {
            ...
            points: [
              {
                title: "Actualización del valor de tus activos:",
                subtitle:
                  "Asegura que tus activos reflejen su valor real, tanto en los libros contables como en el mercado.",
              },
              {
                title: "Optimización en decisiones de inversión:",
                subtitle:
                  "Al conocer el valor real de tus activos, puedes planificar mejor la renovación o reposición de equipos.",
              },
              {
                title: "Cumplimiento normativo:",
                subtitle:
                  "Garantizas que tus registros contables y tributarios cumplan con las normativas actuales en cuanto a la revalorización de activos.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Evaluación inicial de activos:",
                subtitle:
                  "Identificación y categorización de todos los activos fijos que serán objeto de la revalorización.",
              },
              {
                title: "Inspección física:",
                subtitle:
                  "Inspección detallada de cada activo para determinar su estado actual y funcionalidad.",
              },
              {
                title: "Cálculo de depreciación acumulada:",
                subtitle:
                  "Ajuste en los libros contables para reflejar la depreciación correcta de cada activo, considerando su revalorización.",
              },
              {
                title: "Informe contable:",
                subtitle:
                  "Elaboración de un informe detallado con los nuevos valores de los activos para su registro contable.",
              },
              {
                title: "Ajuste en los estados financieros:",
                subtitle:
                  "Modificación de los estados financieros para reflejar los valores revalorizados.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Informe de Revalorización de Activos:",
                subtitle:
                  "Documento detallado con los valores actualizados de cada activo, su depreciación acumulada y su valor de mercado.",
              },
              {
                title: "Recomendaciones de Optimización:",
                subtitle:
                  "Sugerencias sobre activos que podrían ser renovados, vendidos o reemplazados, basadas en su estado actual y valor en el mercado.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title:
                  "Tarifa según el volumen de activos y la complejidad de la revalorización:",
                subtitle: "",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Capacitación en Gestión de Activos:",
                subtitle:
                  "Taller gratuito sobre cómo mantener y optimizar la gestión de tus activos fijos para evitar pérdidas de valor.",
              },
            ],
          },
        ],
      ...
      {
        contentTitle: "CONSULTAS PROFESIONALES",
        contentSubtitle:
          "Resolvemos tus dudas y te asesoramos de manera profesional en Contabilidad, Auditoría y Gestión Empresarial para que tomes decisiones estratégicas informadas y evites errores posteriores.",
        content: [
          {
            name: "BENEFICIOS CLAVE",
            points: [
              {
                ...
                subtitle:
                  "Consulta directa con profesionales experimentados que resuelven tus inquietudes rápidamente.",
              },
              {
                title: "Decisiones informadas:",
                subtitle:
                  "Toma de decisiones estratégicas con base en un análisis profesional.",
              },
              {
                title: "Cumplimiento normativo:",
                subtitle:
                  "Aseguras que todas tus operaciones cumplan con las normativas legales y tributarias vigentes.",
              },
              {
                title: "Ahorro de tiempo y dinero:",
                subtitle:
                  "Evitas errores que pueden resultar en sanciones o pérdidas económicas.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Análisis de casos específicos:",
                subtitle:
                  "Asesoramiento personalizado sobre situaciones particulares de tu empresa, como fusiones, adquisiciones o expansión.",
              },
              {
                title: "Asistencia en la preparación de informes:",
                subtitle:
                  "Te ayudamos a preparar o revisar informes técnicos y financieros para garantizar su precisión.",
              },
            ],
          },
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Documento que resume las recomendaciones y soluciones ofrecidas en cada consulta.",
              },
              {
                title: "Plan de Acción:",
                subtitle:
                  "Estrategias recomendadas para implementar las soluciones discutidas, con pasos claros para su ejecución.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Tarifa por consulta:",
                subtitle:
                  "Cada consulta se cobra individualmente, dependiendo de la complejidad del tema.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Capacitación gratuita:",
                subtitle:
                  "Si contratas un servicio de consultoría extendido, te ofrecemos un taller gratuito para tu equipo sobre los temas clave discutidos en las consultas.",
              },
            ],
          },
        ],
        ...
        content: [
          {
            ...
            points: [
              {
                title: "Simplificación total:",
                subtitle:
                  "Nos encargamos de todos los trámites, asegurando que tu empresa cumpla con todas las normativas.",
              },
              {
                title: "Ahorro de tiempo:",
                subtitle:
                  "Evitas largas colas y trámites burocráticos, dedicando tu tiempo a hacer crecer tu negocio.",
              },
              {
                title: "Cumplimiento legal garantizado:",
                subtitle:
                  "Aseguramos que todos los procesos se realicen conforme a las normativas vigentes.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Trámite de Creación de Empresas:",
                subtitle:
                  "Asesoramiento y ejecución del registro de tu empresa en SEPREC, obtención del NIT y matrícula de comercio.",
              },
              {
                title: "Registro en el Seguro Social de Salud:",
                subtitle:
                  "Inscripción de la empresa y empleados en el sistema de seguro social obligatorio.",
              },
              {
                title: "Aportes a la Gestora Pública:",
                subtitle:
                  "Registro y gestión de los aportes a la Gestora para la seguridad social de largo plazo (jubilación).",
              },
              {
                title: "Obtención de Licencia de Funcionamiento:",
                subtitle:
                  "Tramitación de la licencia municipal que permite operar legalmente.",
              },
              {
                title: "Registro en el Ministerio de Trabajo:",
                subtitle:
                  "Inscripción de la empresa y de los contratos laborales en el Ministerio de Trabajo, además del cumplimiento de obligaciones laborales.",
              },
              {
                title: "Trámites Generales:",
                subtitle:
                  "Incluye permisos de funcionamiento especiales, cumplimiento de normativas de seguridad industrial, medioambientales o cualquier otra exigida según la actividad de la empresa.",
              },
              {
                title: "Asesoría en Normativas Locales:",
                subtitle:
                  "Te orientamos sobre los requisitos específicos de acuerdo a la normativa local para operar de manera legal y eficiente.",
              },
            ],
          },
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Documentos físicos o digitales descritos en los servicios incluidos.",
              },
              {
                title: "Informe de Cumplimiento:",
                subtitle:
                  "Informe detallado con los trámites realizados, fechas de vencimiento y recomendaciones para mantener el cumplimiento legal.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Tarifa por trámite:",
                subtitle:
                  "Cada trámite tiene una tarifa individual, dependiendo de su complejidad.",
              },
              {
                title: "Paquete integral:",
                subtitle:
                  "Incluye todos los trámites desde la creación de la empresa hasta su completa legalización.",
              },
            ],
          },
          {
            ...
            points: [
              {
                ...
                subtitle:
                  "Consulta inicial gratuita sobre los trámites necesarios para tu empresa según su actividad económica.",
              },
            ],
          },
        ],
      ...
      {
        contentTitle: "ASESORAMIENTO GUBERNAMENTAL",
        contentSubtitle:
          "Brindamos asesoramiento legal y técnico especializado para entidades públicas, asegurando el cumplimiento de normativas gubernamentales, optimización de procesos administrativos y la implementación eficiente de políticas públicas.",
        content: [
          {
            name: "BENEFICIOS CLAVE",
            points: [
              {
                ...
                subtitle:
                  "Aseguramos que todas las operaciones de tu Entidad se ajusten a las leyes y reglamentos vigentes.",
              },
              {
                title: "Optimización de la gestión pública:",
                subtitle:
                  "Implementamos mejoras en los procesos administrativos para aumentar la eficiencia y reducir costos.",
              },
              {
                title: "Asesoría especializada:",
                subtitle:
                  "Contamos con un equipo de expertos en Derecho Administrativo, Auditoría Gubernamental y Gestión Pública.",
              },
              {
                title: "Mejor implementación de políticas públicas:",
                subtitle:
                  "Te ayudamos a ejecutar proyectos y programas con mayor impacto y resultados tangibles.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Consultoría en Gestión Pública:",
                subtitle:
                  "Optimización de procesos administrativos en instituciones públicas.",
              },
              {
                title:
              ...
              },
              {
                ...
                subtitle:
                  "Auditoría de gestión y cumplimiento en instituciones públicas.",
              },
              {
                title:
              ...
              },
              {
                ...
                subtitle:
                  "Programas de formación y capacitación en áreas clave como gestión pública, control interno, normativas administrativas aplicables.",
              },
              {
                title: "Asesoría en Implementación de Políticas Públicas:",
                subtitle:
                  "Apoyo en el diseño, planificación y evaluación de políticas públicas sectoriales.",
              },
              {
                title:
          ...
          },
          {
            ...
            points: [
              {
                title: "Informes Técnicos - Legales:",
                subtitle:
                  "Elaboración de documentos que detallan las recomendaciones legales y técnicas para cada área asesorada.",
              },
              {
                title: "Auditorías y Evaluaciones de Gestión:",
                subtitle:
                  "Reportes detallados con los resultados de las auditorías realizadas, junto con propuestas de mejora.",
              },
              {
                title: "Planes de Mejora Administrativa:",
                subtitle:
                  "Diseño de estrategias para optimizar los procesos internos de la entidad pública.",
              },
              {
                title: "Capacitaciones Certificadas:",
                subtitle:
                  "Certificados para los participantes de los talleres y cursos brindados a los funcionarios públicos.",
              },
            ],
          },
          {
            ...
            points: [
              {
                title: "Tarifa según el tipo y alcance del asesoramiento:",
                subtitle: "",
              },
            ],
          },
            ...
            points: [
              {
                ...
                subtitle:
                  "Ofrecemos un análisis preliminar de las áreas clave en las que se necesita asesoramiento.",
              },
            ],
          },
        ],
