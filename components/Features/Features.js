        ...
        <div className="grid grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-3">
          <div className="mb-5">
            <div className="bg-white flex items-center sm:mx-[30px] col:mx-0">
              <div className="bg-azul1 h-[100px] col:h-[80px] col:w-[80px] w-[100px] text-center px-[18px] col:p-0">
              ...
              <div className="pl-[24px]">
                ...
                <h3 className="text-[#333] text-[27px] col:text-[22px] font-medium">Externa</h3>
              </div>
            </div>
          </div>
          <div className="mb-5">
