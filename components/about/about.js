...
import about from '/public/images/integralPro/about_us/img-1.jpg'
               ...
               <div className="grid grid-cols-12 items-center gap-3">
                    <div className="col-span-6 md:col-span-12">
                        <div className="relative mb-[20px]">
                            <div className=" relative max-w-[520px] before:absolute before:bg-celeste1 before:w-full before:h-full before:content-[''] before:-z-10 before:left-[-20px] before:top-[-20px] ">
                    ...
                    <div className="col-span-6 md:col-span-12">
                        <div className="mb-[20px]">
                            ...
                            <p className="text-[#666] text-[15px] leading-[28px] mb-[30px] mt-">INTEGRALPRO S.R.L. Consultores en Contabilidad, Auditoría y Gestión Empresarial. Es una empresa del sector privado constituida en estricto cumplimiento de las Leyes y Normas del Estado Plurinacional de Bolivia, mediante Testimonio No. 176/2020 de fecha 06 de julio de 2020.</p>
                            ...
                            <div className="mb-[50px] col:mb-[20px]">
                                <Link onClick={ClickHandler} href="/nosotros" className="bg-azul1 cursor-pointer text-[16px] font-semibold text-white px-[38px] py-[10px]  capitalize inline-block mt-[6px] transition ease-in-out duration-300 hover:bg-verde1
